    ...
    <div className="min-h-screen bg-zinc-900 text-zinc-100 flex flex-col justify-between">
      <div>
        ...
        <Header
          ...
          onToggleExams={() => { setShowExams(!showExams); setShowTools(false); setShowFun(false); }}
        ...
        <main>
          ...
          {showTools && (
            <div id="tools-portal-section" className="bg-zinc-950/40 border-y border-zinc-800 py-12">
          ...
          {showFun && (
            <div id="fun-games-portal-section" className="bg-zinc-950/40 border-y border-zinc-800 py-12">
              <MathTrivia />
              <GameDirectory />
            </div>
          )}
          ...
          {showExams && (
            <div id="exams-portal-section" className="bg-zinc-950/40 border-y border-zinc-800 py-12">
              <QuizGenerator />
              <WorksheetDownloads />
            </div>
          )}
